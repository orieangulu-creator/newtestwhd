...
为三周后的夏威夷之行准备的离线英语练习 app。覆盖**机场、达美商务舱、入境、租车、浮潜、餐厅、小费、购物**等真实场景，支持逐句循环、A‑B 连播、变速重听、收藏不熟句子并按遗忘曲线复习。
...
- **场景对话（38 个）**：
  ...
  - 入境：CBP 移民问答、海关农产品申报
  - 住宿：Airbnb 自助入住、酒店前台
  - 交通：Uber/出租车、租车·保险·事故、问路、加油站、停车
  - 活动：浮潜、Luau 烤猪宴、海滩、买门票/景点、跟团一日游
  - 应急：药店&911、诊所看医生
  - 餐饮/购物：餐厅点餐、小费、购物、超市、咖啡早餐、得来速快餐
  - 日常：请人拍照/寒暄
  - 🗣️ 地道口语：和当地人闲聊、地道反应附和、口头禅&夏威夷俚语（gonna/wanna、no worries、Aloha/Mahalo/shaka 等）
- **逐句播放器**：单句循环、连播全部、0.6×–1.0× 变速（不变调）、中英对照开关、提示开关
- **关键词点读**：点句中高亮词或词卡，单独听发音
- **⭐ 收藏 + 间隔重复复习**：把不熟的句子加入复习卡组，按遗忘曲线提醒
- **🎧 听力训练**：数字 / 金钱 / 时间 / 航班号专项练耳，先听后揭晓答案
- **⚡ 救场句**：听不懂/卡壳时张口就用的万能句
